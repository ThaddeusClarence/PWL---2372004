                ...
                <div class="lg:col-span-1 space-y-8">
                    <div class="bg-gray-900 p-10 rounded-[40px] text-white shadow-2xl shadow-indigo-100">
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="{{ route('admin.waiting-list.index') }}" class="block w-full text-center bg-amber-500/10 border-2 border-amber-500/20 py-4 rounded-2xl text-xs font-black uppercase tracking-widest transition hover:bg-amber-500 hover:text-white text-amber-600">⏳ Kelola Waiting List</a>
