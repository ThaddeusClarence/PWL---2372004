    ...
    <div class="admin-font bg-[#fbfcfd] min-h-screen pb-20">
        <div class="bg-white border-b border-gray-100 py-10 mb-10 shadow-sm">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <h2 class="text-3xl font-black text-gray-900 leading-tight">Tambah Kategori</h2>
                <p class="text-gray-400 font-medium mt-1">Buat kategori baru untuk mengelompokkan event Anda.</p>
            </div>
        </div>
